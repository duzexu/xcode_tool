...
#蒲公英提供的 用户Key
uKey = '2612e6dda730b0ab3dc5b890f787d5e7'
#上传文件的文件名（这个可随便取，但一定要以 ipa 结尾）
file_name = 'Ecadillac.ipa'
#蒲公英提供的 API Key
_api_key = '82e4083b3eb7b3f45a59a90cd61d3eec'
#安装应用时需要输入的密码，这个可不填
installPassword = '1'
...
def get_ipa_file_path():
    #工作目录下面的 ipa 文件
    ipa_file_workspace_path = '/Users/Shared/Jenkins/Home/jobs/' + project_name + '/workspace/build/' + project_name + '_1.ipa'
    #tomcat 上的 ipa 文件
...
def send_Email(json_result):
    ...
    #邮件接受者
    mail_receiver = ['zexu007@qq.com']
    #根据不同邮箱配置 host，user，和pwd
    mail_host = 'smtp.qq.com'
    mail_user = '847643254@qq.com'
    mail_pwd = 'adu007'
